...
namespace LegendPeak.Platforms
{
    public class PlatformBuilder
    {
        ...
        public PlatformBuilder()
        {
            ...
            //_heightLevelDescriptions.Add(new KeyValuePair<string, PlatformRangeInfo>("ForestSlowLimit", new PlatformRangeInfo(40, 0, 3)));
            _heightLevelDescriptions.Add(new KeyValuePair<string, PlatformRangeInfo>("ForestFastLimit", new PlatformRangeInfo(80, 0, 3)));
            _heightLevelDescriptions.Add(new KeyValuePair<string, PlatformRangeInfo>("CloudSlowLimit", new PlatformRangeInfo(150, 0, 4)));
            _heightLevelDescriptions.Add(new KeyValuePair<string, PlatformRangeInfo>("CloudFast", new PlatformRangeInfo(250, 0, 5)));
			_heightLevelDescriptions.Add(new KeyValuePair<string, PlatformRangeInfo>("StratosphereLimit", new PlatformRangeInfo(400, 1, 6)));
