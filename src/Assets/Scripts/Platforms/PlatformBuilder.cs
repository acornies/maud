...
namespace LegendPeak.Platforms
{
    public class PlatformBuilder
    {
        ...
        public PlatformBuilder()
        {
            ...
            _heightLevelDescriptions.Add(new KeyValuePair<string, PlatformRangeInfo>("Six", new PlatformRangeInfo(120, 1, 6)));
            _heightLevelDescriptions.Add(new KeyValuePair<string, PlatformRangeInfo>("Seven", new PlatformRangeInfo(200, 1, 6)));
            _heightLevelDescriptions.Add(new KeyValuePair<string, PlatformRangeInfo>("Eight", new PlatformRangeInfo(280, 2, 6)));
