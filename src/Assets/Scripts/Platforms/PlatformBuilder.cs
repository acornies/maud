...
namespace LegendPeak.Platforms
{
	public class PlatformBuilder 
	{
	    ...
	    public PlatformBuilder()
		{
			...
			_heightLevelDescriptions.Add(new KeyValuePair<string, PlatformRangeInfo>("One", new PlatformRangeInfo(10, 4, 4)));
		...
		public string GetPlatformPrefabByNumber(int platformNumber)
		{
			...
			{
			    var lastRange = _heightLevelDescriptions.First(i => i.Key == "Ten");
