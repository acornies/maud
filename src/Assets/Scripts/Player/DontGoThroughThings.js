...
function Awake() {
   ...
   playerCollider = transform.FindChild("PlayerModel").GetComponent(Collider);
   minimumExtent = Mathf.Min(Mathf.Min(playerCollider.bounds.extents.x, playerCollider.bounds.extents.y), playerCollider.bounds.extents.z);
